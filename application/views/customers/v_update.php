										...
										<div class="col-8 mx-auto">
											<form action="<?= base_url("customer/update/" . $customer["id_customer"]) ?>" method="post">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('customer_name') ? 'is-invalid' : ''; ?>" name="customer_name" id="customer_name" placeholder="Nama Customer" value="<?= $customer["customer_name"] ?>">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('customer_email') ? 'is-invalid' : ''; ?>" name="customer_email" id="customer_email" placeholder="Email Customer" value="<?= $customer["customer_email"] ?>">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control <?= form_error('customer_phone') ? 'is-invalid' : ''; ?>" name="customer_phone" id="customer_phone" placeholder="Phone Customer" value="<?= $customer["customer_phone"] ?>">
