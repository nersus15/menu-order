...
<body>
	...
	<?php foreach ($gudang as $g) : ?>
		...
		?>
		<h1><?= "Laporan Transaksi Masuk <br>" . kapitalize($namaGudang) . '<br>' . (!empty($tgl) ? $tgl[0] . ' sd ' . $tgl[1] : null) ?></h1>
		<br>
		<hr>
		<br>
				...
				<tbody>
					...
					<?php foreach ($g['transaksi'] as $v) : ?>
						<tr>
							...
							<td><?= $v["namagudang_asal"] .  " - " . ($v['lvlwil_asal'] == '1' ? 'Prov. ' : ($v['lvlwil_asal'] == '3' ? 'Kec. ' : '-')) . kapitalize($v['namawil_asal']) ?></td>
							<td>
