											...
											<tbody>
												...
												<?php foreach ($items as $item) : ?>
													<tr>
														...
														<td><?= $item->id ?></td>
														<td><?= $item->nama ?></td>
														<td><?= kapitalize($item->wilayah_gudang) ?></td>
                                                        <td>
                                                            <ul>
														...
														<td>
															...
															<a data-toggle="tooltip" data-placement="bottom" title="Hapus" href="<?= base_url("item/delete/" . $item->id) ?>" class="btn btn-icco btn-danger btn-delete"><i class="fas fa-trash"></i></a>
														</td>
													</tr>
												<?php endforeach; ?>
											</tbody>
